...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.56a3e4dace8522a5eadef649d14df59a7fc28361420a1f83553c5d10b6bffe04.js',function(){input.required=false;search();});}
